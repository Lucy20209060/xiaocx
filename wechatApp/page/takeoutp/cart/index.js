...
Page({
  ...
  getList: function () {
    ...
    app.commonAjax('cat/orderFood/orderMenuIndex', ['shopId', 'memberId', 'bizId'], {}, function (res) {
  ...
  settle: function(){
    ...
    app.commonAjax('cat/orderFood/minisubmit', ['shopId', 'memberId'], subdata, function (res) {
      wx.navigateTo({
        url: '/page/takeout/cart/submit/index'
      })
    },app)
